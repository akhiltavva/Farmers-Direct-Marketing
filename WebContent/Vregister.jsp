...
<%@ include file = "header.jsp" %>   
	...
	<form method="post" action="UploadVendorRegister" enctype="multipart/form-data" class="text-center border border-light p-5">

    <p class="h4 mb-4">Register as vendor</p>

    <!-- Email -->
    <input type="text" name="vname" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="Vendor Name" required>
